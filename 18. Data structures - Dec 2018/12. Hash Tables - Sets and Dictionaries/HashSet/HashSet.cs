namespace HashSet
{
    ...
    public class HashSet<TKey>: IEnumerable<TKey>
    {
        ...
        public HashSet<TKey> IntersectsWith(HashSet<TKey> other)
        {
        ...
        {
            return this.UnionWith(other).Except(this.IntersectsWith(other));
        }
